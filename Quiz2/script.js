const questions = [
    ...
    { question: "What is the recommended range from which a temperature should be selected and maintained constantly to achieve targeted temperature management after cardiac arrest?", choices: ["32°C to 36°C", "25°C to 28°C", "35°C to 37°C", "29°C to 31°C"], correct: 0, image: "https://raw.githubusercontent.com/canisiome/ACLS_verA/main/Dot.png" }, 
    ...
    { question: "Your patient is in cardiac arrest and has been intubated. To assess CPR quality, which should you do?", choices: ["Check the patient's pulse", "Obtain a 12-lead ECG", "Obtain a chest x-ray", "Monitor the patient's PETCO2"], correct: 3, image: "https://raw.githubusercontent.com/canisiome/ACLS_verA/main/Dot.png" },
    ...
    { question: "Which of these tests should be performed for a patient with suspected stroke as soon as possible but no more than 20 minutes after hospital arrival?", choices: ["Coagulation studies", "Cardiac enzymes", "Non-contrast CT scan of the head", "12-Lead ECG"], correct: 2, image: "https://raw.githubusercontent.com/canisiome/ACLS_verA/main/Dot.png" },
    ...
    { question: "Which of these tests should be performed for a patient with suspected stroke as soon as possible but no more than 20 minutes after hospital arrival?", choices: ["12-lead ECG", "Cardiac Enzymes", "Coagulation studies", "Non-contrast CT scan of the head"], correct: 3, image: "https://raw.githubusercontent.com/canisiome/ACLS_verA/main/Dot.png" },
    { question: "What is the minimum systolic blood pressure one should attempt to achieve with fluid administration or vasoactive agents in a hypotensive post-cardiac arrest patient who achieves return of spontaneous circulation?", choices: ["75 mmHg", "80 mmHg", "85 mmHg", "90 mmHg"], correct: 3, image: "https://raw.githubusercontent.com/canisiome/ACLS_verA/main/Dot.png" },
    ...
    { question: "A 68-year-old woman presents with light-headedness, nausea, and chest discomfort. Your assessment finds her awake and responsive but appearing ill, pale, and grossly diaphoretic. Her radial pulse is weak, thready, and fast. You are unable to obtain a blood pressure. She has no obvious dependent edema, and her neck veins are flat. Her lung sounds are equal, with moderate rales present bilaterally. The cardiac monitor shows the rhythm seen here.<br><br>On the basis of this patient's initial assessment, which ACLS algorithm should you follow?", choices: ["Adult Tachycardia With a Pulse", "Adult Cardiac Arrest", "Acute Coronary Syndromes", "Adult Suspected Stroke"], correct: 0, image: "https://raw.githubusercontent.com/canisiome/ACLS_verA/main/Monomorphicventriculartach.png" },
    { question: "Which best describes this rhythm?", choices: ["Ventricular fibrillation", "Monomorphic ventricular tachycardia", "Polymorphic ventricular tachycardia", "Supraventricular tachycardia"], correct: 1, image: "https://raw.githubusercontent.com/canisiome/ACLS_verA/main/Monomorphicventriculartach.png" },
